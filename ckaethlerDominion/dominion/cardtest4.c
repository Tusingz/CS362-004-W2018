...
** DESCRIPTION: TESTS THE CARD COUNCIL ROOM IN DOMINION.C
*****/
...
int main() 
{
	// VARIABLES OUTLINED FOR COUNCIL ROOM GAMEPLAY
    int newCards = 4;
    int newActions = 0;
    int newBuys = 1;
    int discarded = 1;
	...
	// TEST: COMPARES HAND COUNT BEFORE AND AFTER COUNCIL ROOM CARD USED-------
	...
	// TEST: COMPARES BUY COUNT BEFORE AND AFTER COUNCIL ROOM CARD USED--------
	...
	// TEST: COMPARES ACTION COUNT BEFORE AND AFTER COUNCIL ROOM CARD USED-----
	...
	// TEST: COMPARES COIN COUNT BEFORE AND AFTER COUNCIL ROOM CARD USED-------
	...
	if ((testDeck != (thisDeck - 1)) || ((thisHand + 1) != testHand))
	{
